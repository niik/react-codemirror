...
var CodeMirror = React.createClass({
	...
	propTypes: {
		...
		onRenderLine: React.PropTypes.func,
	...
	componentDidMount: function componentDidMount() {
		...
		this.codeMirror.on('changes', this.codemirrorValueChangedBatch);
	...
	renderLine: function renderLine(cm, line, element) {
		this.props.onRenderLine && this.props.onRenderLine(cm, line, element);
	},
	...
	codemirrorValueChangedBatch: function codemirrorValueChangedBatch(cm, changes) {
		this.props.onChanges && this.props.onChanges(cm, changes);
	},
